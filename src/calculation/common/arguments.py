...
variables = [
    ...
    "SKIMTIME", "SKIMDISTANCE_MIC_FIRSTLEG", "SKIMDISTANCE_MIC_LASTLEG",
    "SKIMDISTANCE",
    "LINKS", "NODES",
    "EMISSIONFACS",
...
# Which variables consist of lists seperated by a comma
lists = [
    "MODULES",
    "BIKE_USER_CLASSES",
    "BIKE_PERIODS",
...
files = [
    ...
    "SKIMDISTANCE_MIC_FIRSTLEG", "SKIMDISTANCE_MIC_LASTLEG",
    "LINKS", "NODES",
    "EMISSIONFACS",
    "EMISSIONFACS_BUITENWEG_LEEG", "EMISSIONFACS_BUITENWEG_VOL",
    "EMISSIONFACS_SNELWEG_LEEG", "EMISSIONFACS_SNELWEG_VOL",
